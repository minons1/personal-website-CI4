        ...
        <div class="col-4">
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Its distinctive black sauce with soft meat is a mainstay menu that is usually eaten
                by Surabaya residents and tourists who come to Surabaya.</p>
            </div>
          </div>
        </div>
        <div class="col-4">
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Made from beef, fried tofu, bean sprouts, watercress and yellow noodles. All these
                ingredients are cut into pieces and then poured with a soup</p>
            </div>
          </div>
        </div>
        <div class="col-4">
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">First local food. This famous food from the City of Heroes consists of rice cake,
                bean sprouts, fried tofu, lentho, fried onions, soy sauce and chili sauce.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-4">
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Made from clover leaves and spourts, its uniqueness is the spoon is made from
                crackers</p>
            </div>
          </div>
        </div>
        <div class="col-4">
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">There is two tipe of rujak. One with all cooked ingredients and another one with
                fruit but one sauce</p>
            </div>
          </div>
        </div>
        <div class="col-4">
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Named 'tek' because the seller usually get around and make sound 'tek tek tek' with
                their equipment</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-4">
          <div class="card custom-card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">One of the oldest ice cream from surabaya. First owned by Robert Zangrandi and
                developed by an Indonesian</p>
            </div>
          </div>
        </div>
        <div class="col-4">
